  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center p-4 selection:bg-primary selection:text-primary-foreground relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute top-[10%] -left-[10%] w-[50%] h-[50%] rounded-full bg-accent/20 blur-3xl" />
        <div className="absolute -bottom-[20%] -right-[10%] w-[40%] h-[40%] rounded-full bg-primary/10 blur-3xl" />
      </div>

      <div className="w-full max-w-md">
        <div className="text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-accent/10 text-accent mb-4 shadow-inner">
            <Shield className="h-8 w-8" />
          </div>
          <h1 className="text-4xl font-extrabold tracking-tight lg:text-5xl mb-2">Create Account</h1>
          <p className="text-muted-foreground text-lg">Start managing your bills securely today</p>
        </div>
        ...
        <Card className="p-8 shadow-2xl border-border/50 bg-card/80 backdrop-blur-xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-150 relative overflow-hidden">
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground flex items-center justify-center gap-1">
            ...
            <Link to="/login" className="font-semibold text-accent hover:underline transition-colors hover:text-accent/80">
              Sign in instead
            </Link>
          </div>
        </Card>
